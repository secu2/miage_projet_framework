...
public class ServeurRMI extends UnicastRemoteObject implements InterfaceServeurRmi {
	...
	*/ 
	 ...
	 * @return utilisateursConnectes
	 */
	public ArrayList<ClientRMI> getUtilisateursConnectes() throws RemoteException{
		return utilisateursConnectes;
	}
	...
	public boolean inscription(String login, String motDePasse)
			throws NoSuchAlgorithmException, UnsupportedEncodingException, RemoteException {
	 ...
	 */
	public void creerUnRepertoireUtilisateur(Utilisateur u, String path) throws RemoteException{
	 ...
	 * @param publications
	 */
	public void setPublications(ArrayList<Publication> publications) throws RemoteException{
