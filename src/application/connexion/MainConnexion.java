...
import application.chat.Inscription;
...
public class MainConnexion {
	...
	public void initialize() throws ParseException {
		...
		frmConnexionAuServeur.setBounds(100, 100, 257, 234);
		...
		btnConnexion.addMouseListener(new MouseAdapter() {
			@Override public void mouseClicked(MouseEvent arg0) {
				try {
					...
					JOptionPane.showMessageDialog(frmConnexionAuServeur, "Impossible de se connecter, vérifiez vos informations de connexion (" + e + ")", "Inane error", JOptionPane.ERROR_MESSAGE);
					e.printStackTrace();
				}
		...
		JButton btnInscription = new JButton("Pas encore inscrit ? Inscription");
		btnInscription.setBounds(10, 174, 231, 23);
		frmConnexionAuServeur.getContentPane().add(btnInscription);
