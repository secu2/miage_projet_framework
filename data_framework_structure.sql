CREATE TABLE "fichier" ("fichier_id" INTEGER PRIMARY KEY  NOT NULL );
CREATE TABLE "groupes" ("id_groupe" INTEGER PRIMARY KEY  NOT NULL  UNIQUE , "groupname" VARCHAR DEFAULT noname);
